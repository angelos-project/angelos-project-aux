...
public abstract class AbstractSponge1024 : AbstractSponge(16, 16) {
    override fun round() {
        ...
        mask = (r0 and sponge[0] and sponge[2] and sponge[4] and sponge[6]) xor
                ((r1 and -mask.inv() and sponge[8] and sponge[10]) * 2) xor
                ((r2 and sponge[12] and sponge[14]) * 4) xor
                ((r3 and sponge[15]) * 8) xor
                (-counter.inv() * 16)
