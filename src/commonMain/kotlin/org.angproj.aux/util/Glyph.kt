/**
 * Copyright (c) 2034 by Kristoffer Paulsson <kristoffer.paulsson@talenten.se>.
 *
...
@JvmInline
public value class GlyphString(private val glyphs: IntArray)

@JvmInline
public value class UtfString(private val str: ByteArray)
