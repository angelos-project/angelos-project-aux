...
public enum class Sanitizer {
    ...
    public companion object: States<Sanitizer> {
        override val transitionMap: Map<Sanitizer, List<Sanitizer>> = mapOf(
            START to listOf(ASCII, FIRST_OF_TWO, FIRST_OF_THREE, FIRST_OF_FOUR, FIRST_OF_FIVE, FIRST_OF_SIX, FINISH),
            RESTART to listOf(ASCII, FIRST_OF_TWO, FIRST_OF_THREE, FIRST_OF_FOUR, FIRST_OF_FIVE, FIRST_OF_SIX, FINISH),
            ASCII to listOf(RESTART, FINISH),
            FIRST_OF_TWO to listOf(TWO_COMPLETED),
            TWO_COMPLETED to listOf(RESTART, FINISH),
            FIRST_OF_THREE to listOf(SECOND_OF_THREE),
            SECOND_OF_THREE to listOf(THREE_COMPLETED),
            THREE_COMPLETED to listOf(RESTART, FINISH),
            FIRST_OF_FOUR to listOf(SECOND_OF_FOUR),
            SECOND_OF_FOUR to listOf(THIRD_OF_FOUR),
            THIRD_OF_FOUR to listOf(FOUR_COMPLETED),
            FOUR_COMPLETED to listOf(RESTART, FINISH),
            ...
            FIVE_COMPLETED to listOf(RESTART, FINISH),
            ...
            SIX_COMPLETED to listOf(RESTART, FINISH),
            FINISH to listOf(),
            ERROR to listOf()
        )

        override val beginsWith: Sanitizer = START
        override val endsWith: Sanitizer = FINISH
    }
}