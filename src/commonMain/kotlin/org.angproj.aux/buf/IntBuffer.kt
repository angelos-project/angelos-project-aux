...
public fun IntBuffer.copyOf(): IntBuffer = innerCopyOfRange(0, size)
public fun IntBuffer.copyOfRange(idxFrom: Int, idxTo: Int): IntBuffer = innerCopyOfRange(idxFrom, idxTo)