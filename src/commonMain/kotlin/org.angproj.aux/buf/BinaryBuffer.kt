...
public class BinaryBuffer internal constructor(
    ...
    override fun readUByte(): UByte =
        _segment.getByte(_position).conv2uB<Unit>().also { _position += TypeSize.uByte }

    override fun readShort(): Short =
        _segment.getShort(_position).also { _position += TypeSize.short }

    override fun readUShort(): UShort =
        _segment.getShort(_position).conv2uS<Unit>().also { _position += TypeSize.uShort }

    override fun readInt(): Int =
        _segment.getInt(_position).also { _position += TypeSize.int }

    override fun readUInt(): UInt =
        _segment.getInt(_position).conv2uI<Unit>().also { _position += TypeSize.uInt }

    override fun readLong(): Long =
        _segment.getLong(_position).also { _position += TypeSize.long }

    override fun readULong(): ULong =
        _segment.getLong(_position).conv2uL<Unit>().also { _position += TypeSize.uLong }

    override fun readFloat(): Float =
        _segment.getInt(_position).conv2F<Unit>().also { _position += TypeSize.float }

    override fun readDouble(): Double =
        _segment.getLong(_position).conv2D<Unit>().also { _position += TypeSize.double }
    ...
    override fun readRevUShort(): UShort =
        _segment.getRevShort(_position).conv2uS<Unit>().also { _position += TypeSize.uShort }

    override fun readRevInt(): Int =
        _segment.getRevInt(_position).also { _position += TypeSize.int }

    override fun readRevUInt(): UInt =
        _segment.getRevInt(_position).conv2uI<Unit>().also { _position += TypeSize.uInt }

    override fun readRevLong(): Long =
        _segment.getRevLong(_position).also { _position += TypeSize.long }

    override fun readRevULong(): ULong =
        _segment.getRevLong(_position).conv2uL<Unit>().also { _position += TypeSize.uLong }

    override fun readRevFloat(): Float =
        _segment.getRevInt(_position).conv2F<Unit>().also { _position += TypeSize.float }

    override fun readRevDouble(): Double =
        _segment.getRevLong(_position).conv2D<Unit>().also { _position += TypeSize.double }
    ...
    override fun writeUByte(value: UByte): Unit =
        _segment.setByte(_position, value.conv2B<Unit>()).also { _position += TypeSize.uByte }
    ...
    override fun writeUShort(value: UShort): Unit =
        _segment.setShort(_position, value.conv2S<Unit>()).also { _position += TypeSize.uShort }
    ...
    override fun writeUInt(value: UInt): Unit =
        _segment.setInt(_position, value.conv2I<Unit>()).also { _position += TypeSize.uInt }
    ...
    override fun writeULong(value: ULong): Unit =
        _segment.setLong(_position, value.conv2L<Unit>()).also { _position += TypeSize.uLong }

    override fun writeFloat(value: Float): Unit =
        _segment.setInt(_position, value.conv2I<Unit>()).also { _position += TypeSize.float }

    override fun writeDouble(value: Double): Unit =
        _segment.setLong(_position, value.conv2L<Unit>()).also { _position += TypeSize.long }
    ...
    override fun writeRevUShort(value: UShort): Unit =
        _segment.setRevShort(_position, value.conv2S<Unit>()).also { _position += TypeSize.uShort }
    ...
    override fun writeRevUInt(value: UInt): Unit =
        _segment.setRevInt(_position, value.conv2I<Unit>()).also { _position += TypeSize.uInt }
    ...
    override fun writeRevULong(value: ULong): Unit =
        _segment.setRevLong(_position, value.conv2L<Unit>()).also { _position += TypeSize.uLong }

    override fun writeRevFloat(value: Float): Unit =
        _segment.setRevInt(_position, value.conv2I<Unit>()).also { _position += TypeSize.float }

    override fun writeRevDouble(value: Double): Unit =
        _segment.setRevLong(_position, value.conv2L<Unit>()).also { _position += TypeSize.long }
}
