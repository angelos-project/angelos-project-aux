...
public value class UIntType(public val value: UInt) : Enfoldable {
    override fun foldSize(foldType: FoldType): Long = UInt.SIZE_BYTES.toLong()
    ...
    override fun enfold(outStream: Writable): Long {
        outStream.writeShort(Convention.UINT.type)
    ...
    public companion object : Unfoldable<UIntType> {
        ...
        override fun unfold(inStream: Readable): UIntType {
            require(inStream.readShort() == Convention.UINT.type)
