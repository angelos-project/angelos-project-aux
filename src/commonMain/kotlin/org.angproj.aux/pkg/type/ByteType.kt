...
public value class ByteType(public val value: Byte) : Enfoldable {
    override fun foldSize(foldType: FoldType): Long = Byte.SIZE_BYTES.toLong()
    ...
    override fun enfold(outStream: Writable): Long {
        outStream.writeShort(Convention.BYTE.type)
    ...
    public companion object : Unfoldable<ByteType> {
        ...
        override fun unfold(inStream: Readable): ByteType {
            require(inStream.readShort() == Convention.BYTE.type)
