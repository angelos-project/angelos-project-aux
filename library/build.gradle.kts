...
object This {
    const val longName = "Auxiliaries - Angelos Project™"
    const val longDescription = "A library of auxiliary utilities for Angelos development."
    const val url = "https://github.com/angelos-project/angelos-project-aux"
}
...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url.set(This.url)
            connection.set("scm:git:git://github.com/angelos-project/angelos-project-aux.git")
            developerConnection.set("scm:git:ssh://github.com:angelos-project/angelos-project-aux.git")
        }
    }
}
