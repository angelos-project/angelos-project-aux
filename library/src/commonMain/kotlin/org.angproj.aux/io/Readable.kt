...
public interface Readable {
     ...
     * @return An unsigned short integer of data.
     */
    public fun readRevUShort(): UShort
     ...
     * @return A double of data.
     */
    public fun readRevDouble(): Double
}